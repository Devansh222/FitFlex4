      ...
      <div className="container">
        <div className="footer-content">
          ...
          <img className='img' src={img} alt="Bench Press" />
            <span className='name'>Devansh Workout App</span>
            <p className='p11'>&copy; 2024 Devansh Workout App. All rights reserved.</p>
          </div>
...
//         <div className="app-name">Devansh Workout App</div>
